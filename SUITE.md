...
|---|---|---|---|
| Decision records (architecture) | format | 1.8 | decision-records/DECISION-RECORDS-STANDARD.md |
| Functional specification | format | 1.5 | functional-specs/FUNCTIONAL-SPECS-STANDARD.md |
